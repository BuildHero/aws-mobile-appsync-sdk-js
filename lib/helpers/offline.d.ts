 ...
 * @param operationType
 */
declare const buildSubscription: (subscriptionQuery: CacheUpdateQuery, cacheUpdateQuery: CacheUpdateQuery, idField?: string, operationType?: CacheOperationTypes) => SubscribeToMoreOptions;
 ...
 */
declare const buildMutation: <T = OperationVariables>(client: ApolloClient<any>, mutation: any, variablesInfo: T | VariablesInfo<T>, cacheUpdateQuery: CacheUpdatesOptions, typename: string, idField?: string, operationType?: CacheOperationTypes) => MutationOptions;
